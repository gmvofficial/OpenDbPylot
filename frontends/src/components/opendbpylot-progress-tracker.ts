...
@customElement('opendbpylot-progress-tracker')
export class OpenDbPylotProgressTracker extends LitElement {
  static styles = [
    tokens,
    css`
      :host {
        ...
        border-radius: 0 0 var(--opendbpylot-border-radius-lg) var(--opendbpylot-border-radius-lg);
        overflow: hidden;
        font-family: var(--opendbpylot-font-family-default);
      }

      .progress-label {
        padding: var(--opendbpylot-space-3) var(--opendbpylot-space-4) var(--opendbpylot-space-2);
        display: flex;
        align-items: center;
      ...
      .progress-item {
        padding: var(--opendbpylot-space-3) var(--opendbpylot-space-4);
        border-bottom: 1px solid var(--opendbpylot-outline-dimmest);
        display: flex;
        align-items: flex-start;
        gap: var(--opendbpylot-space-3);
        transition: background var(--opendbpylot-duration-150) ease;
      }
      ...
      .progress-item.in_progress {
        ...
        border-left: 3px solid var(--opendbpylot-accent-primary-default);
      }
      ...
      .progress-item.error {
        background: var(--opendbpylot-accent-negative-subtle);
        border-left: 3px solid var(--opendbpylot-accent-negative-default);
        padding-left: calc(var(--opendbpylot-space-3) - 3px);
      }
      ...
      .progress-item.error .progress-detail {
        color: var(--opendbpylot-accent-negative-default);
        font-weight: 500;
      }
      ...
      .progress-icon.pending {
        background: var(--opendbpylot-outline-default);
      }
      ...
      .progress-icon.completed {
        background: var(--opendbpylot-accent-positive-default);
      }

      .progress-icon.error {
        background: var(--opendbpylot-accent-negative-default);
        box-shadow: 0 0 0 2px var(--opendbpylot-accent-negative-subtle);
      }
      ...
      .progress-text {
        ...
        font-weight: 500;
        margin: 0 0 var(--opendbpylot-space-1) 0;
        line-height: 1.3;
      }
      ...
      .empty-state {
        padding: var(--opendbpylot-space-6) var(--opendbpylot-space-4);
        text-align: center;
        color: var(--opendbpylot-foreground-dimmest);
        font-size: 12px;
      }
