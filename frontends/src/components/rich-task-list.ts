...
export class RichTaskList extends LitElement {
  static styles = [
    ...
    css`
      ...
      .task-list-title {
        margin: 0 0 var(--opendbpylot-space-3) 0;
        font-size: 1rem;
        font-weight: 600;
      ...
      .progress-fill {
        ...
        border-radius: 3px;
        transition: width var(--opendbpylot-duration-300) ease;
      }
      ...
      .progress-fill.status-warning {
        background: var(--opendbpylot-accent-warning-default);
      }
      ...
      .task-list-items {
        padding: var(--opendbpylot-space-2);
      }
      ...
      .task-item {
        ...
        gap: var(--opendbpylot-space-3);
        padding: var(--opendbpylot-space-3);
      ...
      .task-title {
        font-weight: 500;
        color: var(--opendbpylot-foreground-default);
        margin-bottom: var(--opendbpylot-space-1);
      }

      .task-description {
        font-size: 0.875rem;
        color: var(--opendbpylot-foreground-dimmer);
        margin-bottom: var(--opendbpylot-space-2);
      }
      ...
      @media (max-width: 768px) {
        .task-list-header {
          padding-left: var(--opendbpylot-space-4);
          padding-right: var(--opendbpylot-space-4);
        }
